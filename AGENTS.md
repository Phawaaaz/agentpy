...
tests/          smoke/phase2/mcp/pipeline/memory/cli_skills/external_skills/multiagent/offload/model_switch/auth/planning/search/retry/model_info/config_yaml/workspace/concurrency/storage/token/usage_store/hooks_test.py — all fakes, no key
```
...
**Always run all twenty-two test files after a change** and keep them passing.
